...
class ServiceV2 extends Component {
  render() {
    ...
    return (
      <section className='service-section section-padding section-bg Agape-go-top'>
        <div className='container'>
          ...
          <div className='row'>
            <div className='col-lg-4 col-md-6'>
              {/* SingleBox */}
              <div
                className='single-service-box service-white-bg text-center wow fadeIn animated'
